...
После вставки кода форма не останется пустой: элементы и кнопки (**Save Card / Create DOCX / Validate / Export PDF / Close**) создаются в `UserForm_Initialize` динамически.
